const CACHE_NAME="ten-category-bible-plan-v8-in-app-player";
const ASSETS=["./","./index.html","./manifest.webmanifest","./icon-192.png","./icon-512.png","./lsb-audio-map.json","./v8-player.js?v=8"];
